...
int main(int argc, char *argv[])
{
    ...
    std::vector<double> r(numgridpoints_x*numgridpoints_y,0.0);
    std::cout<<" Parameter initilization done"<<std::endl;
    ...
    std::cout << "Domain Decmposition done\n";
    // Memory Allocation
    ...
    if(cart_rank==0)
    {
  	...
  	std::cout << "R computation done -: r= f-Au\n";
    //******************************************************
 ...
 /* else
  ...
  std::cout<<" r and u are distributed from 0 to others"<<std::endl;
  ...
  std::cout << "d is initilizated with r\n";
  ...
  if(up<0 || down <0)
    ...
    std::cout << "Inner index call  done :  just before cg\n";
